...
class AccAccExt(models.Model):
    ...
    #     ('asset_accumulated_description', 'Additional Mail'),
    #     ('asset_inventory', 'Additional Mail'),
    #     ('asset_other_current', 'Additional Phone'),
    #     ('asset_intangible', 'Additional Phone'),
    #     ('asset_lease_receivables', 'Additional Phone'),
    #     ('asset_consumables', 'Additional Phone'),
    #     ('asset_motor_vehicles', 'Additional Phone'),
    #     ('asset_raw_materials', 'Additional Phone'),
    #     ('asset_third_party_stocks', 'Additional Phone'),
    #     ('asset_rigs_n_related_equipments', 'Additional Phone'),
    #     ('asset_construction_inprogress', 'Additional Phone'),
    #     ('asset_non_current_recv', 'Additional Phone'),
    #     ('asset_software_cost', 'Additional Phone'),
    #     ('asset_bonus_dep_res', 'Additional Phone'),
    #     ('asset_deferred_inv_tax', 'Additional Phone'),
    #     ('asset_quoted_invest', 'Additional Phone'),
    #     ('asset_unquoted_invest', 'Additional Phone'),
    #     ('asset_noncurrent_prepayments', 'Additional Phone'),
    #     ('asset_noncurrent_prepayments', 'Additional Phone'),
    #     ('asset_inv_prov_acc', 'Additional Phone'),
    #     ('asset_trade_n_other_rec', 'Additional Phone'),
    #     ('asset_dividend_rec', 'Additional Phone'),
    #     ('asset_dividend_rec', 'Additional Phone'),
    #     ('asset_statutory_rec', 'Additional Phone'),
    #     ('asset_staff_rec', 'Additional Phone'),
    #     ('asset_other_rec', 'Additional Phone'),
    #     ('asset_deposits', 'Additional Phone'),
    #     ('asset_current_lease_rec', 'Additional Phone'),
    #     ('asset_prov_for_doubt_bank_bal', 'Additional Phone'),
    #     ('asset_land_n_building', 'Additional Phone'),
    #     ('asset_it_equip', 'Additional Phone'),
    #     ('asset_furn_fix_equip', 'Additional Phone'),
    #     ('asset_classified_as_held_for_sale', 'Additional Phone'),
    #     ('asset_goodwill', 'Additional Phone'),
    #     ('asset_capitalized_interest', 'Additional Phone'),
    # ])
